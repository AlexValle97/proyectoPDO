...
<?php  }else{ ?>
                ...
                <a href="#"><i class="fas fa-sign-in-alt"></i> <?php echo $_SESSION['usuNombre'], '', $_SESSION['usuApellido']; ?></a>
                        </button>
                        <div class="dropdown-menu bg-dark" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item bg-dark" href="logout.php">Salir del sistema</a>
                            <a class="dropdown-item bg-dark" href="logout.php">action2</a>
                            <a class="dropdown-item bg-dark" href="logout.php">action3</a>
                        </div>
<?php } ?>
    </div>
</nav>
